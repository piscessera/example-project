...
```mermaid
graph TD
    C1[ขั้นตอน 1: นั่งที่โต๊ะ เห็น QR code เฉพาะของโต๊ะ]
    C2[ขั้นตอน 2: สแกน QR code ด้วยกล้องมือถือ]
...
|---|---|---|---|---|
| C1 | นั่งที่โต๊ะ เห็น QR code เฉพาะของโต๊ะติดอยู่ | QR code sticker บนโต๊ะ | #1 สแกน QR code เพื่อเปิดหน้าเว็บสั่งอาหาร | |
| C2 | สแกน QR code ด้วยกล้องมือถือของตัวเอง | กล้องมือถือลูกค้า | #1 สแกน QR code เพื่อเปิดหน้าเว็บสั่งอาหาร | |
